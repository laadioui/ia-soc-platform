...
def main():
    ...
    if r.status_code == 201:
        ...
        if r.status_code == 200:
            ...
            actions = ["login_failed", "login_success", "port_scan", "privilege_escalation", "file_access", "process_creation", "network_connection"]
            ...
            r = httpx.post(f"{BASE}/api/v1/incidents", json={
            ...
            # Test 11: Create IOC
            r = httpx.post(f"{BASE}/api/v1/threat-intelligence/iocs", json={
                "ioc_type": "ip",
            ...
            # Test 13: AI analyze
            r = httpx.post(f"{BASE}/api/v1/ai/analyze", json={
            ...
            r = httpx.post(f"{BASE}/api/v1/response/block-ip", json={
