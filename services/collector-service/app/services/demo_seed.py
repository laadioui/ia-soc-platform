...
IOCS = [
    {
        ...
        "severity": "high",
        "confidence": 0.85,
        "description": "Known brute force source IP (Tor exit node)",
    ...
    },
    {
        ...
        "severity": "critical",
        "confidence": 0.90,
        "description": "SHA256 of known ransomware sample",
        "source": "virustotal",
        "threat_type": "malware",
    },
    {
...
THREAT_INTEL = [
    ...
    },
    {
        ...
        "confidence": 0.75,
        "severity": "medium",
        "description": "Mass scanner targeting RDP and SSH endpoints",
        "source": "AbuseIPDB",
        "tags": ["scanner", "rdp", "ssh"],
        "related_mitre": ["T1046"],
        "tlp": "green",
    },
    {
        "indicator_type": "domain",
        "indicator_value": "cdn-metrics-tracker.net",
        "threat_type": "c2",
        "confidence": 0.81,
        "severity": "high",
        "description": "Fake CDN domain used for beaconing",
        "source": "Recorded Future",
        "tags": ["c2", "beacon", "cdn"],
        "related_mitre": ["T1071", "T1567"],
        "tlp": "amber",
    },
]
...
def _alert_defs(now: datetime) -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "source": "firewall",
            "rule_id": "C2-BEACON-001",
            "rule_name": "Command and Control Beacon",
            "event_count": 62,
            "first_seen": m(360),
            "last_seen": m(6),
            "risk_score": 0.95,
        ...
        {
            "alert_id": "ALT-1010",
            "title": "Data Exfiltration Suspicion",
            "severity": "critical",
            "status": "new",
            "source": "firewall",
            "rule_id": "EXFIL-001",
...
async def seed_demo_data(session: AsyncSession) -> dict[str, int]:
    ...
    counts.update(
        {
            "rules": len(DETECTION_RULES),
            "mitre": len(MITRE_TECHNIQUES),
            "iocs": len(IOCS),
